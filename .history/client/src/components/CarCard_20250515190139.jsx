...
const CarCard = ({ car }) => {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-6 p-4 bg-white rounded-2xl shadow-md hover:shadow-xl transition-shadow duration-300 max-w-5xl mx-auto">
      ...
      {/* Right: Car Details Box */}
      <div className="w-full md:w-1/2 bg-gray-50 rounded-xl border border-gray-200 p-6 flex flex-col justify-between gap-4">
        
        {/* Title and Description */}
        <div className="space-y-2">
          <h2 className="text-3xl font-semibold text-gray-800">{car.make} {car.model}</h2>
          <p className="text-sm text-gray-600">{car.description || 'Keine Beschreibung vorhanden'}</p>
        ...
        {/* Price */}
        <div className="bg-white p-4 rounded-xl border border-gray-300 shadow-sm flex justify-between items-center">
          <div>
        ...
        <div className="flex items-center gap-4 bg-white p-4 rounded-xl border border-gray-300 shadow-sm">
          ...
          />
          <div className="text-sm text-gray-700">
            <p className="font-medium text-base">{dealer.name}</p>
