...
const AddCar = () => {
  ...
  return (
    <>
      {message && (
        <div
          className={`fixed top-4 right-4 z-50 px-4 py-2 rounded shadow text-white transition-all duration-300 ${
      ...
      <form
        ...
        className="max-w-lg mx-auto p-4 bg-white dark:bg-gray-900 rounded shadow"
      >
        <h2 className="text-xl font-bold mb-4 text-gray-800 dark:text-white">Add New Car</h2>
