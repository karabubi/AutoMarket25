...
const AddCar = () => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="max-w-4xl mx-auto p-6 bg-white dark:bg-gray-900 rounded shadow-md space-y-4">
      <h2 className="text-2xl font-bold text-gray-800 dark:text-white">Add New Car</h2>
      {message && <p className="text-center text-sm text-red-500 dark:text-green-400">{message}</p>}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <input {...register('engine_size', { valueAsNumber: true })} type="number" step="0.1" placeholder="Engine Size (L)" className="input" />
        ...
        <input {...register('consumption_combined', { valueAsNumber: true })} type="number" step="0.1" placeholder="Consumption (L/100km)" className="input" />
        <input {...register('co2_emission', { valueAsNumber: true })} type="number" placeholder="CO2 Emission (g/km)" className="input" />
...
// tailwind styles (globally in index.css or inside a Tailwind component)
// .input {
//   @apply w-full p-2 border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-800 text-black dark:text-white focus:outline-none focus:ring focus:ring-blue-400;
// }
