...
// ✅ CarCard.jsx — only shows image gallery and details (no uploads)
...
//   //Users/salehalkarabubi/works/project/AutoMarket25/client/src/assets/logo.png
...
const CarCard = ({ car }) => {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto bg-white rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden mb-8">
