...
const CarCard = ({ car }) => {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto p-4 bg-white rounded-2xl shadow-md hover:shadow-xl transition-shadow duration-300">
      ...
      {/* Pricing & Action */}
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center bg-gray-50 mt-4 p-4 rounded-xl border border-gray-200 gap-4">
        <div>
      ...
      {/* Dealer Info */}
      <div className="flex items-center mt-4 gap-4 bg-gray-50 p-4 rounded-xl border border-gray-200">
        <img
          src={dealer.logoUrl}
          alt={`${dealer.name} logo`}
