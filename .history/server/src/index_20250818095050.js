...
//Users/salehalkarabubi/works/project/AutoMarket25/server/src/index.js
...
// app.use('/api/users', userRoutes);
// app.use('/api/email', emailRoutes);
// app.use('/api/admin', adminRoutes); // ✅ Admin API route
...
// const carRoutes = require('./routes/carRoutes');
// console.log('✅ carRoutes loaded');
// const userRoutes = require('./routes/userRoutes'); // ✅ merged here
// console.log('✅ userRoutes loaded');
// const emailRoutes = require('./routes/emailRoutes');
// console.log('✅ emailRoutes loaded');
...
// app.use('/api/auth', authRoutes);
// app.use('/api/cars', carRoutes);
// app.use('/api/users', userRoutes); // ✅ correctly merged here
// app.use('/api/email', emailRoutes);
