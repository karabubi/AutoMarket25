  ...
  return (
    <div className="max-w-6xl mx-auto p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {cars.map((car) => (
          <div key={car.id} className="bg-white rounded-2xl shadow p-4 flex flex-col">
            <img
            ...
            <p className="text-gray-600 text-sm">Baujahr: {car.year}</p>
            <p className="text-gray-600 text-sm">Laufleistung: {car.mileage?.toLocaleString()} km</p>
            <p className="text-gray-600 text-sm">Leistung: {car.power_kw} kW</p>
            <p className="text-gray-600 text-sm mb-2">Preis: €{car.price.toLocaleString()}</p>
